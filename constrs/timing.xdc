...
create_generated_clock -name clk_tdc0 [get_pins u_CdcmMan_Inst/inst/mmcm_adv_inst/CLKOUT0]
create_generated_clock -name clk_tdc1 [get_pins u_CdcmMan_Inst/inst/mmcm_adv_inst/CLKOUT1]
create_generated_clock -name clk_tdc2 [get_pins u_CdcmMan_Inst/inst/mmcm_adv_inst/CLKOUT2]
create_generated_clock -name clk_tdc3 [get_pins u_CdcmMan_Inst/inst/mmcm_adv_inst/CLKOUT3]
